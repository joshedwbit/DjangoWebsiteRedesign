"""
Django settings for ideapadproj1 project.
...
SECRET_KEY = 'django-insecure-xnwed8kjx(x(s@h=ym#_j6=m5eol1avpsl5f2+_y%9pr3jsk&c'
...
ROOT_URLCONF = 'ideapadproj1.urls'
...
WSGI_APPLICATION = 'ideapadproj1.wsgi.application'
